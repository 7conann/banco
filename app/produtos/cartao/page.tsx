          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  <div className="inline-flex items-center bg-yellow-500 text-black px-4 py-2 rounded-lg text-sm font-semibold mb-6">
                  ...
                  <h1 className="text-5xl md:text-6xl font-bold mb-6 text-black leading-tight">
                    ...
                    <span className="text-yellow-500"> Criptomoedas</span>
                  </h1>
                    ...
                    <div className="mt-8">
                      ...
                      <div className="flex justify-between items-end">
                        <div>
                          ...
                          <div className="font-semibold">SEU NOME</div>
                        </div>
                  ...
                  <CardContent>
                    <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg mb-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="text-3xl font-bold text-yellow-600 mb-1">6,38%</div>
                          <div className="text-sm font-semibold text-yellow-800">de economia em cada compra internacional</div>
                        </div>
